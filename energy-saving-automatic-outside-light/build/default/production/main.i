...
void main(void) {
    ...
    if (CM1CON0bits.OUT & !deadTime){LATHbits.LATH3=1;}
    else{LATHbits.LATH3=0;}

    dateIncrement(&daylightSavings, &dayOfWeek, &dayOfMonth, &month, &year);
    ...
    sprintf(buf2,"Date: %d/%d/%d  ",dayOfMonth,month,year);
    LCD_setline(1);
    LCD_sendstring(buf1);
    LCD_setline(0);
    LCD_sendstring(buf2);
